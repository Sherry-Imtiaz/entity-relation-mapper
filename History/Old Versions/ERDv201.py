...
APP_VERSION = "v2.0.0"
APP_VERSION_NAME = "Rendered Mermaid ERD View - Phase 1"
APP_CHANGELOG = [
    {
...
def render_mermaid_diagram(mermaid_code: str, height: int = 750) -> None:
    """Render Mermaid ERD directly inside Streamlit using a lightweight HTML component."""
...
def main() -> None:
    ...
    with tab_erd:
        ...
        erd_display_mode = st.radio(
            "ERD display mode",
            ["Rendered Mermaid", "Graphviz", "Both"],
            index=0,
            horizontal=True,
            key="erd_display_mode",
        )
        ...
        if not state.tables:
            ...
            if erd_display_mode in {"Rendered Mermaid", "Both"}:
                st.markdown("### Rendered Mermaid ERD")
                render_mermaid_diagram(mermaid)

            if erd_display_mode in {"Graphviz", "Both"}:
                st.markdown("### Graphviz ERD")
