...
APP_VERSION = "v2.0.4"
APP_VERSION_NAME = "Streamlit Flow ERD Visual Styling Patch"
APP_CHANGELOG = [
    {
...
def build_table_node_content(table: TableInfo) -> str:
    """Build clean Markdown content for a Streamlit Flow table node."""
    line_break = chr(10)
    ...
    if key_columns:
        ...
        for col in key_columns:
            ...
            lines.append(f"{marker} `{col.column_name}`")
    ...
    if hidden_count:
        lines.extend(["", f"_… {hidden_count} more columns_"])
